...
HardwareSerial mySerial(2);  // Use UART2 for ESP32 (Pin 1=RX, 12=TX)
...
byte rowPins[ROWS] = { 14, 13, 12, 11 };  // Example GPIO pins

// Connect keypad COL0, COL1, COL2 and COL3 to these Arduino pins.
byte colPins[COLS] = { 10, 9, 46, 3 };  // Example GPIO pins

// Create the keypad
Keypad keypad = Keypad(makeKeymap(keys), rowPins, colPins, ROWS, COLS);

// Declaration for SSD1306 display connected to I2C (SDA pin, SCL pin, OLED_RESET pin)
...
// Assuming the dimensions of the bitmap are 128x64 pixels
...
void setup() {
  ...
  while (!Serial)
    ;  // Wait for console to open, necessary for native USB

  mySerial.begin(57600, SERIAL_8N1, 1, 2);  // Set up the sensor serial connection
  finger.begin(57600);                      // Initialize fingerprint sensor at its operating baud rate
